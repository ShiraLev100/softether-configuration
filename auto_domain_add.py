...
def change_password(username, new_password):
    try:
        ...
        print(f"Changed password to user {username} to the new password: {new_password}.")

    except subprocess.CalledProcessError as e:
        print(f"Error code: {e.returncode}\n Error message: Failed to change password to user {username}")
